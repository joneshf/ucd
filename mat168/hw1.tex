...
\begin{document}
  ...
  \begin{enumerate}
    ...
    \item [1.2]
      ...
      % \begin{alignat*}{19}
      %   \text{maximize}   \quad \mathrlap{\sum_{i = 1}^{9} s_ix_i}                                                                                               \\
        ...
        \item
          \begin{tikzpicture}
            \begin{axis}[axis on top,smooth,
              ...
              \addplot[name path global=c1,very thick, domain=-15:15]{12 - x};
              \addplot[name path global=c2,very thick, domain=-15:15]
                coordinates { (10, -15) (10, 15) };
              \addplot[name path global=c3,very thick, domain=-15:15]
                coordinates { (-15, 7) (15, 7) };
              \addplot[name path global=c4,very thick, domain=-15:15]{2 * x};
              \addplot[name path global=c5,very thick, domain=-15:15]{0.5 * x};
              \foreach \d in {34, 68, 102, 136, 170}{
                \addplot[domain=-15:15]{(\d / 17) - (11 / 17) * x};
              }
