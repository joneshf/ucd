    ...
    \item Solve exercise 1.2.1.
        \begin{enumerate}
            ...
            Proof that $\sqrt{3}$ is irrational.
                ...
                Since $\mathbb{Z}$ is closed under multiplication,
                $q^2 \in \mathbb{Z}$ so we can rename it $r$ for clarity.
                ...
                We can substitute the value of $p^2$ from $(2)$ into $(1)$.
                ...
                Since $\mathbb{Z}$ is closed under multiplication,
                $r^2 \in \mathbb{Z}$ so we can rename it $s$ for clarity.
                ...
                $p$ and $q$ are relatively prime. So our assumption was false,
