        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                ...
                \item
                    ...
                    However, a more useful result to prove would be
                    a generalization that the square root of some number is
                    irrational.
                    This way we can know for certain whether the square root of
                    a number is irrational or rational by its properties and
                    not by performing a formal proof.
            ...
            \item
                ...
                One such counter example is when $x^2 = 36$.
                In this case, $x^2$ is divisible by $4$.
                However, $x$ (which is $6$) is not divisible by $4$.
