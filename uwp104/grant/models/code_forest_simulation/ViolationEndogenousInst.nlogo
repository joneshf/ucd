...
to turtle-actions
  ask turtles [
    ...
    ;introdotta violazione
    ifelse ([trees] of patch-here > current-institution) or (abs (minimal-cut - current-institution) > tolerance-threshold or payoff-satisfaction = 0)
